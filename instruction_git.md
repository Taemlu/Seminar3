...
Чтобы перейти между ветками, нужно ввести команду:
...
При этом \<branch name> - имя вливаемой ветки. Вливать нужно находясь в той ветке, куда хочешь влить. (Совершить переход в такую ветку путем git checkout \<branch name>)


#### Конфликты слияния

<<<<<<< HEAD
Если при слиянии в двух версиях файла одна и та же строка напечатан по разному происходит конфликт и Git не сможет слить версии без нашей помощи. Мы должны будем сравнить строки с конфликтом и выбрать, какую строку оставить. При необходимости внести изменения вручную после слияния.
=======
Если при слиянии в двух версиях файла одна и та же строка напечатан по разному, то будет конфликт
>>>>>>> merging
